...
<style scoped>
 /* calc(100vh - 44px) */
.maxBox{width: 100vw;height: calc(100vh - 44px);background: #fff;top: 44px;}
.videoP{width: 100vw;top: 0;margin-top: 20px;}
.cellVidio{margin: 10px 0;}
.videoC{width: calc(100vw - 20px);border-radius: 8px;background: #fffae8;}
.videoName{text-align: left;margin: 0 10px}
</style>